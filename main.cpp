...
int main(int argc, char** argv){
    ...
    try{
        ...
        tgui::Tab::Ptr tab = tgui::Tab::create();// = theme->load("tab");
        tab->setTabHeight(30);
        ...
        tgui::MenuBar::Ptr menu = tgui::MenuBar::create();// = theme->load("MenuBar");
        ...
        tgui::Label::Ptr label = tgui::Label::create();// = theme->load("label");
        label->setText("This is a label.\nAnd these are radio buttons:");
        label->setPosition(10, 90);
        label->setTextSize(18);
        gui.add(label);

        tgui::RadioButton::Ptr radioButton = tgui::RadioButton::create();// = theme->load("RadioButton");
        ...
        tgui::EditBox::Ptr editBox = tgui::EditBox::create();// = theme->load("EditBox");
        ...
        tgui::ListBox::Ptr listBox = tgui::ListBox::create();// = theme->load("ListBox");
        ...
        tgui::ProgressBar::Ptr progressBar = tgui::ProgressBar::create();// = theme->load("ProgressBar");
        ...
        //label = theme->load("label");
        label->setText(patch::to_string(progressBar->getValue()) + "%");
        ...
        tgui::Slider::Ptr slider = tgui::Slider::create();// = theme->load("slider");
        slider->setPosition(10, 560);
        slider->setSize(200, 18);
        slider->setValue(4);
        gui.add(slider);

        tgui::Scrollbar::Ptr scrollbar = tgui::Scrollbar::create();// = theme->load("scrollbar");
        ...
        tgui::ComboBox::Ptr comboBox = tgui::ComboBox::create();// = theme->load("ComboBox");
        ...
        tgui::ChildWindow::Ptr child = tgui::ChildWindow::create();// = theme->load("ChildWindow");
        ...
        tgui::Button::Ptr button = tgui::Button::create();// = theme->load("button");
        ...
        tgui::CheckBox::Ptr checkbox = tgui::CheckBox::create();// = theme->load("checkbox");
        ...
        tgui::ChatBox::Ptr chatbox = tgui::ChatBox::create();// = theme->load("ChatBox");
